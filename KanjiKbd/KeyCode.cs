...
namespace KanjiKbd {
    public class KeyCode {
        ...
        private static readonly int[] asciiToScanCode = {
            ...
            0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x02A, 0x02B, 0x028, 0x000, 0x000, 0x028, 0x000, 0x000, //0x00-0x0F
            0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x029, 0x000, 0x000, 0x000, 0x000, //0x10-0x1F
            ...
            0x013, 0x014, 0x015, 0x016, 0x017, 0x018, 0x019, 0x01A, 0x01B, 0x01C, 0x01D, 0x130, 0x189, 0x132, 0x12e, 0x04C};//0x70-0x7F

        public static readonly byte[] keyToScanCode = new byte[256];

        public static int CharToCode(char c) {
            return KeyCode.asciiToScanCode[Convert.ToUInt16(c)];
        }
